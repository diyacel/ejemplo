...
import ec.edu.monster.beans.sessions.XeusuUsuarFacade;
...
public class XeusuUsuarController implements Serializable {
    ...
    @EJB
    private ec.edu.monster.beans.sessions.XeusuUsuarFacade ejbFacade;
    ...
    protected void setEmbeddableKeys() {
        selected.getXeusuUsuarPK().setPeempCodig(selected.getPeempEmpleado().getPeempCodig());
    }

    protected void initializeEmbeddableKey() {
        selected.setXeusuUsuarPK(new ec.edu.monster.entidades.XeusuUsuarPK());
    }
    ...
    public XeusuUsuar getXeusuUsuar(ec.edu.monster.entidades.XeusuUsuarPK id) {
    ...
    public static class XeusuUsuarControllerConverter implements Converter {
        ...
        ec.edu.monster.entidades.XeusuUsuarPK getKey(String value) {
            ec.edu.monster.entidades.XeusuUsuarPK key;
            String values[] = value.split(SEPARATOR_ESCAPED);
            key = new ec.edu.monster.entidades.XeusuUsuarPK();
            key.setPeempCodig(Integer.parseInt(values[0]));
            key.setXeusuCodigo(values[1]);
            return key;
        }

        String getStringKey(ec.edu.monster.entidades.XeusuUsuarPK value) {
            StringBuilder sb = new StringBuilder();
            sb.append(value.getPeempCodig());
            sb.append(SEPARATOR);
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof XeusuUsuar) {
                ...
                return getStringKey(o.getXeusuUsuarPK());
            } else {
