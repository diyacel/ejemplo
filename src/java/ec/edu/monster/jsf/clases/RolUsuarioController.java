...
import ec.edu.monster.beans.sessions.RolUsuarioFacade;
...
public class RolUsuarioController implements Serializable {
    ...
    @EJB
    private ec.edu.monster.beans.sessions.RolUsuarioFacade ejbFacade;
    ...
    public RolUsuario getRolUsuario(java.util.Date id) {
    ...
    public static class RolUsuarioControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof RolUsuario) {
                ...
                return getStringKey(o.getRusFechaAsignacion());
            } else {
