...
import ec.edu.monster.beans.sessions.XeEstEstadoFacade;
...
public class XeEstEstadoController implements Serializable {
    ...
    @EJB
    private ec.edu.monster.beans.sessions.XeEstEstadoFacade ejbFacade;
    ...
    public static class XeEstEstadoControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof XeEstEstado) {
                ...
                return getStringKey(o.getXeuestCodigo());
            } else {
