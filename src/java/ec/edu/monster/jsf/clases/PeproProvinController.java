...
import ec.edu.monster.beans.sessions.PeproProvinFacade;
...
public class PeproProvinController implements Serializable {
    ...
    @EJB
    private ec.edu.monster.beans.sessions.PeproProvinFacade ejbFacade;
    ...
    public PeproProvin getPeproProvin(java.lang.String id) {
    ...
    public static class PeproProvinControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof PeproProvin) {
                ...
                return getStringKey(o.getPeproCodigo());
            } else {
